...
namespace scriptcoin
{
    public class Util
    {
        ...
        public static readonly List<string> Jokes = new List<string>()
        {
            ...
            {"I don't really like long nails, but they're really growing on me" },
            ...
            {"I saw a sign that said 'falling rocks' so I tried, and it just hurt" },
            ...
            {"What do you call a dinosour with an extensive vocabulary? A Thesaurus" },
            {"I was going to make a belt out of watches, but then I realized that would be a waist of time" },
            {"Why can't you run in a campground? You can only ran, it's all past tents" },
            ...
            {"Wow that high class trout really is so-fish-dicated" },
            {"The policemen said if I don't pay my library fine he would have to book me" },
            {"It was an emotional wedding, even the cake was in tiers..." },
            {"Being a SCUBA diver must be the worst job, they always work under pressure." },
            {"Did you hear about the atlantis themed reasturant? It went under." },
            {"I’ve never understood the fashion industry, those people are so clothes minded..." },
            {"I was told I had Type A blood but turns out it was a Type O" },
