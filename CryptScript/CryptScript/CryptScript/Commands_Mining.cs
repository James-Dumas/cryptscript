...
namespace CryptScript
{
    public static partial class Data
    {
        ...
        public static List<Command> MiningCommands = new List<Command>
        {
            ...
            new Command("display", "Shows a realtime hash rate display", delegate(string[] input)
            {
                if(Program.IsMining)
                {
                    if(Monitor.Wallet == "")
            ...
            new Command("start", "Starts the miner", delegate(string[] input)
            {
                Program.IsMining = true;
                Display.Write("Mining has started.", ConsoleColor.Green);
            }),

            new Command("stop", "Stops the miner", delegate(string[] input)
            {
            ...
            new Command("ret", "Returns to the main dialogue", delegate(string[] input)
            {
